...
/* to slide the delete button. Colt Steele does this effect with CSS. He sets the width of the bin span to 0 and then creates a new .deleteToDo:hover that it will transition to a larger width */
